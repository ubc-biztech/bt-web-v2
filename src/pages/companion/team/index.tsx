    ...
    return (
        ...
        >
            <div className='w-full h-full flex flex-col items-center justify-center font-bricolage space-y-4 bg-[#111111] mt-24'>
                ...
                <header className='text-[32px]'>Welcome to Kickstart, <span className='font-bold'>{reg?.fname}</span></header>
                <GlowButton href="/companion/team/create" height='h-10' width='w-56'>
                    Create a team
                </GlowButton>
                <span>
                    {"or "}
                    <Link className='text-[#DE7D02] underline' href="/companion/team/join">
