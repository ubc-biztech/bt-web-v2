...
const BootCamp = () => {
  ...
  useEffect(() => {
    const mock: Video[] = [
      { id: "1", title: "Introduction to Software Development", isCompleted: true },
      { id: "2", title: "Video Name Here", isCompleted: true },
      { id: "3", title: "Video Name Here", isCompleted: true },
      { id: "4", title: "Video Name Here", isCompleted: true },
      { id: "5", title: "Video Name Here", isCompleted: false },
    ];
      ...
      <div className="text-white p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto p-2">
          ...
          <div className="bg-[#1B253D] border border-[#A2B1D5] rounded-2xl p-6">
            ...
            <div className="relative aspect-video bg-[#0D172C] rounded-lg mb-6 flex items-center justify-center border border-[#A2B1D5]">
              <div className="text-center">
                <div className="mb-6">
                  <div className="w-20 h-20 bg-[#1B253D] border border-[#A2B1D5] rounded-full flex items-center justify-center mx-auto mb-4 relative">
