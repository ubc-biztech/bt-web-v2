...
const Companion = () => {
    ...
    const styles = {
        container:
            "min-h-screen w-screen bg-gradient-to-b from-[#040C12] to-[#030608] relative overflow-hidden",
    ...
    const fetchUserData = async () => {
        ...
        try {
            ...
            if (!reg) {
                setError(
                    "This email does not match an existing entry in our records."
                );
                setIsLoading(false);
                return;
            }
    ...
    if (pageError) {
        return (
            <div className="w-screen h-screen flex items-center justify-center">
                <div>
                    A page error occurred, please refresh the page. If the
                    problem persists, contact a BizTech exec for support.
                </div>
            </div>
        );
    }
