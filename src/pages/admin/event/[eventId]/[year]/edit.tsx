            ...
            try {
                ...
                const transformedData = {
                    ...
                    customQuestions: Array.isArray(data.registrationQuestions) 
                        ...
                        : [],
                    partnerCustomQuestions: Array.isArray(data.partnerRegistrationQuestions)
        ...
        <div className="bg-primary-color min-h-screen">
            <div className="mx-auto flex flex-col">
                {isLoading ? (
                    ...
                    <EventForm initialData={initialData} onSubmit={handleSubmit} eventId={eventId as string} eventYear={year as string} />
                ) : null}
            </div>
        </div>
    );
