        ...
        <main className="bg-primary-color min-h-screen">
            <div className="container mx-auto p-10 flex flex-col">
                <span>
                    ...
                    <p className="text-baby-blue font-poppins">Manage Events {">"} {router.query.eventId} {router.query.year}</p>
                </span>
                {/*divider*/}
                ...
                {isLoading ? (
                    ...
                    <DataTable initialData={data} dynamicColumns={dynamicColumns}/>
                )}
            </div>
        </main>
    );
