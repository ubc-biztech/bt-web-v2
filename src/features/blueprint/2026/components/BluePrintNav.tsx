...
export const BluePrintNav: React.FC<SideNavProps> = ({ isPartner }) => {
  ...
  const navLinks = useMemo(
    () => [
      { href: "/companion/blueprint/2026", label: "Home" },
      // Always show My Profile link - show loading or error state if needed
      ...(profileId
        ? [
            {
              href: `/companion/blueprint/2026/profile/${profileId}`,
              label: "My Profile",
            },
          ]
        : profileLoading
      ...
      {
        href: "/companion/blueprint/2026/connections",
        label: "Connections",
      },
      {
        href: "/companion/blueprint/2026/discover",
        label: "Discover People",
      },
      { href: "/companion/blueprint/2026/quests", label: "Quests" },
    ],
    ...
    <>
      <div>
        <div className="flex flex-row justify-between mx-4 mt-4">
          <Link href="/companion/blueprint/2026">
            <Image
