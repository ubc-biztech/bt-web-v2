...
const BluePrintConnections2026 = ({ eventId, year }: DynamicPageProps) => {
    ...
    <BluePrintLayout>
      <div className="flex flex-col gap-3 pb-6">
        <div className="flex items-center justify-between mt-4">
          <Link href={`/companion/${eventId}/${year}`}>
...
function ConnectionCard({
  ...
  return (
    <Link href={`/companion/${eventId}/${year}/profile/${profileId}`}>
...
export default BluePrintConnections2026;
// import BluePrintLayout from "../layout/BluePrintLayout";

// export default function BluePrintConnections2026() {
//   return <BluePrintLayout>Connections page</BluePrintLayout>;
// }
