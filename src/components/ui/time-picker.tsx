    ...
    return (
        <div className={cn("flex items-end gap-2", className)}>
            <div className="grid gap-1 text-center">
                <Label htmlFor="hours" className="text-xs text-white">Hours</Label>
                <Input
                    ref={hourRef}
                    id="hours"
            ...
            <div className="grid gap-1 text-center">
                <Label htmlFor="minutes" className="text-xs text-white">Minutes</Label>
                <Input
                    ref={minuteRef}
                    id="minutes"
                    className="w-16 text-center bg-[#3A496D] text-white border-gray-600"
            ...
            <div className="grid gap-1 text-center">
                <Label htmlFor="period" className="text-xs text-white">Period</Label>
                <button
                    id="period"
