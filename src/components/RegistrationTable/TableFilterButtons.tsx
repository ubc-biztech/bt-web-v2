    ...
    return (
        <div className="bg-[#95AADC] rounded-md flex items-center space-x-5">
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger>
                        <Button variant="ghost" onClick={() => table.toggleAllRowsSelected(false)}>
                            <Image src={CancelIcon} alt="Deselect Icon" width={15} height={15} className={"min-w-3"} />
                        </Button>
                    </TooltipTrigger>
                    <TooltipContent>
                        Deselect
            ...
            <div className="flex flex-row">
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger>
                            <Button variant="ghost" onClick={() => handleIconClick('addToTeam')}>
                                <Image src={TeamsIcon} alt="Teams Icon" width={25} height={25} className={"min-w-6"} />
                            </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                            Add to Team
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger>
                            <Button variant="ghost" onClick={() => handleIconClick('massUpdateStatus')}>
                                <Image src={MassUpdateIcon} alt="Mass Update Icon" width={25} height={25} className={"min-w-6"} />
                            </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                            Mass Update Status
