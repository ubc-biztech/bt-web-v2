            ...
            >
              <header className="text-2xl font-ibm mb-4">
                ...
                <span className="text-[#898BC3]">
                  {userRegistration?.basicInformation?.fname}{" "}
                  {userRegistration?.basicInformation?.lname}
                </span>
              </header>
              <p className="font-ibm mb-8 text-sm text-white text-center">
                Looks like you haven&apos;t formed a team yet. Let&apos;s get
                you set up!
              </p>
              <form onSubmit={handleTeamSubmit} className=" max-w-sm w-full">
                <div className="font-ibm mb-4">
                  <input
                    ...
                    className={`w-full p-3 bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#898BC3] placeholder-[#898BC3] ${
                      errors.teamName ? "border-2 border-[#DE3163]" : ""
                    }`}
                  />
                  {errors.teamName && (
                ...
                <div className="font-ibm mb-4">
                  <input
                    ...
                    className={`w-full p-3 bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#898BC3] placeholder-[#898BC3] ${
                      errors.member1 ? "border-2 border-[#DE3163]" : ""
                    }`}
                  />
                  {errors.member1 && (
                    <p className="font-ibm text-xs text-[#DE3163] mt-1">
                ...
                <div className="font-ibm mb-4">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#898BC3] placeholder-[#898BC3] ${
                      errors.member2 ? "border-2 border-[#DE3163]" : ""
                    }`}
                  />
                  {errors.member2 && (
                    <p className="font-ibm text-xs text-[#DE3163] mt-1">
                ...
                <div className="font-ibm mb-4">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#898BC3] placeholder-[#898BC3] ${
                      errors.member3 ? "border-2 border-[#DE3163]" : ""
                    }`}
                  />
                  {errors.member3 && (
                    <p className="font-ibm text-xs text-[#DE3163] mt-1">
