...
type AttendeeEventRegistrationFormSchema = z.infer<typeof attendeeEventRegistrationFormSchema>;

interface AttendeeEventRegistrationFormProps {
    event: BiztechEvent;
    initialData?: Partial<AttendeeEventRegistrationFormSchema>;
    onSubmit: (data: AttendeeEventRegistrationFormSchema) => void;
}

export const AttendeeEventRegistrationForm: React.FC<AttendeeEventRegistrationFormProps> = ({ event, initialData, onSubmit }) => {
    const form = useForm({
        resolver: zodResolver(attendeeEventRegistrationFormSchema),
    ...
    const handleSubmit = (data: Partial<AttendeeEventRegistrationFormSchema>) => {
        // Type assertion to EventFormSchema
        onSubmit(data as AttendeeEventRegistrationFormSchema);
        toast({
            title: "Event Created",
