                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6 bg-[#253251] container py-10">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button type="submit" className="bg-biztech-green">SAVE</Button>
                                </div>
                                    ...
                                    render={({field}) => (
                                        <FormItem className="flex items-center space-x-2">
                                            ...
                                            <FormLabel className="font-normal">
                                                This is an application based event (i.e. you will accept / reject applicants)
                                            </FormLabel>
                                        </FormItem>
                                    )}
                                />
                                ...
                                <div>
                                    ...
                                    {customQuestions.map((field, index) => (
                                        <div key={field.id} className="my-4 p-4 border rounded-lg bg-[#3A4A70]">
                                            ...
                                            />
                                            {(field.type === 'select' || field.type === 'checkbox' || field.type === 'workshopSelection') && (
                                                <FormField
                                                    control={form.control}
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem>
                                                            ...
                                                            <FormDescription>
                                                                Separate options by commas, no spaces (Option1,Option2)
                                                            </FormDescription>
                                                            <FormMessage/>
                                                        </FormItem>
                                                    )}
